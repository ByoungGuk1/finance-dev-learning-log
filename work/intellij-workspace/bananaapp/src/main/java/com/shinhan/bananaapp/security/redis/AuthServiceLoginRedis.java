...
import com.shinhan.bananaapp.security.jwt.RefreshTokenEntity;
import com.shinhan.bananaapp.security.jwt.RefreshTokenService;
...
public class AuthServiceLoginRedis {
  ...
  public Map<String, TokenResponse> login(MemberEntity dto) {
    ...
    result.put("accessToken", new TokenResponse(accessToken, member));
    result.put("refreshToken", new TokenResponse(refreshToken, member));
    return result;
  }
