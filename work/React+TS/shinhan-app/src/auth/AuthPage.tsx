...
import type { MemberType } from "@/auth/MemberType";
import { useLocation, useNavigate } from "react-router-dom";
import LoginFields from "@/auth/components/LoginFields";
import SignupFields from "@/auth/components/SignupFields";
import AddressModal from "@/auth/components/Addressmodal";
...
export default function AuthPage() {
  ...
  const signup = async () => {
    ...
    await ApiService.post("/auth/joinProc", {
      mid,
      mpassword,
      mname,
      mrole,
