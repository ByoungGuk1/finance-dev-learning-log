...
type TxnAction =
  ...
  | { type: "RESET" }; // 실습: 위 힌트를 참고해 이 타입을 완성하세요.
...
// 관리 할 상태 값이 많으면 component가 복잡
// 상태 관리를 분리할 때 : useReducer

// 상태 관리 : balance, history(입출금 내역)

export default function AccountBalance() {
  // TODO :useReducer(txnReducer, initialState)로 state, dispatch를 만드세요.
  // const [상태 값을 담을 변수, reducer에 있는 로직 호출 함수] = useReducer(로직있는 함수, 초기 값)
